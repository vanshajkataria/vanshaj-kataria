    ...
    <>
      ...
      <div className="border-t-[1px] border-white/25">
        <div className="py-2 flex justify-between items-center">
          <h2 className="text-xl font-medium py-0.5">Image Builder App</h2>
          <div className="flex gap-2 justify-center items-center">
            <Link
              href="https://github.com/vanshajkataria/image-builder-app"
              target="_blank"
            ...
            <Link
              href="https://image-builder-app.vercel.app/"
              target="_blank"
              className="hover:border-b-2 hover:border-yellow-400 py-0.5 duration-300 ease-in-out transition-all"
            >
              <span>
